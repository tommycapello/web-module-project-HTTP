...
- [done] cd into the project base directory `cd web-module-project-HTTP`
- [done] Download server dependencies by running `npm install`
- [done] Run the local web server by running `node server.js`
- [done] Open a new terminal window and cd into the client code `cd client`
